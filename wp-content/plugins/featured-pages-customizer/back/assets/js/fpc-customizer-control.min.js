...
jQuery(document).ready(function(){!function(a){"use strict";var b=a("select","#accordion-section-tc_fpc"),c=a("input[type=checkbox]","#accordion-section-tc_fpc");b.selecter(),c.iCheck({checkboxClass:"icheckbox_flat-grey",radioClass:"iradio_flat-grey"}),c.on("ifChanged",function(){a(this).trigger("change")})}(window.jQuery)}),function(a){var b=wp.customize,c=TCFPCControlParams.ShowFP,d=TCFPCControlParams.ShowExcerpt,e=TCFPCControlParams.ShowButton;a.each({"tc_fpc_options[tc_show_fp]":{controls:c,callback:function(a){return 1==a}},"tc_fpc_options[tc_show_fp_text]":{controls:d,callback:function(a){return 1==a}},"tc_fpc_options[tc_show_fp_button]":{controls:e,callback:function(a){return 1==a}}},function(c,d){b(c,function(c){a.each(d.controls,function(a,e){b.control(e,function(a){var b=function(b){a.container.toggle(d.callback(b))};b(c.get()),c.bind(b)})})})})}(jQuery);