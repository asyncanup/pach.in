...
/*
  ...
  Copyright 2012  Brennan Thompson  (email : brenjt@gmail.com)
...
require_once(WPSTICKY_PLUGIN_DIR . '/wpsn-admin/wpsn-admin.php');
...
if (!class_exists("wpStickyNotes")) {
    ...
    class wpStickyNotes {
        ...
        public $colors = array(
            '_sticky_note_01' => array('bg' => 'DAFE70', 'border' => 'C5FC57', 'text' => '5F8F00'),
            '_sticky_note_02' => array('bg' => 'FFC465', 'border' => 'FCBB5D', 'text' => 'A35F00'),
            '_sticky_note_03' => array('bg' => 'FEF276', 'border' => 'FDEB61', 'text' => 'AD9600'),
            '_sticky_note_04' => array('bg' => '66B0EC', 'border' => '569AF9', 'text' => '2E5380'),
            '_sticky_note_05' => array('bg' => 'EC6EFD', 'border' => 'E761ED', 'text' => '662669'),
            '_sticky_note_06' => array('bg' => 'F96060', 'border' => 'F75050', 'text' => '8F3434')
        );
        public $shortcode;

        public function wpStickyNotes() {
            $this->__construct();
        }
        ...
        public function stickynote_ajax_post_create() {
            ...
            $hidedate = mysql_real_escape_string($_POST['hidedate']);
            ...
            update_post_meta($newStickyNoteID, '_stickynote_hidedate', $hidedate);
        ...
        public function shortcode() {
            ...
            return $wpStickyNotes_shortcode->setup_stickynotes();
        }
...
//global $wpStickyNotes_shortcode;
        ...
        public function install() {
            ...
            add_option('_stickynote_position', 'top');
            add_option('_stickynote_background', '1');
        }

        public function do_colors() {
